...
_FAKE_SCRIPT_JSON = json.dumps({
    ...
    "cards": [
        ...
        {"lines": ["Nhưng có một điều", "rất ít người để ý tới."],
         ...
         "chart": {"kind": "chips", "items": [{"label": "Astra"}, {"label": "Fable"},
                                              {"label": "Opus"}]}},
        {"lines": ["Công cụ không tự nhiên", "làm bạn giỏi hơn được."],
         "variant": "mark", "anchor": "mid", "motion_in": "wipe", "motion_out": "up",
         "chart": {"kind": "gauge", "items": [{"label": "Điểm đạt", "value": 98.6},
                                              {"label": "Trần", "value": 100}]}},
        ...
        {"lines": ["Đây là trang GitHub", "của dự án đang gây bão."],
         ...
         "screenshot_url": "https://github.com/openai/codex"},
        ...
        {"lines": ["Bản mới rút xuống", "chưa tới bốn phút là xong."],
         ...
         "chart": {"kind": "stat", "items": [{"label": "Bản cũ", "value": 120},
                                             {"label": "Bản mới", "value": 4}],
                   "unit": "phút"}},
        {"lines": ["Đội kiểm định độc lập", "đã chạy lại toàn bộ bài đo."],
         "variant": "stack", "anchor": "mid", "motion_in": "rise", "motion_out": "dissolve",
         "chart": {"kind": "hbar", "items": [{"label": "Công bố", "value": 92},
                                             {"label": "Đo lại", "value": 71},
                                             {"label": "Trung bình ngành", "value": 64}]}},
        ...
        {"lines": ["Người dùng thật", "lại quan tâm tới thứ hoàn toàn khác."],
         ...
         "chart": {"kind": "line", "items": [{"value": 12}, {"value": 34}, {"value": 58},
                                             {"value": 77}]}},
