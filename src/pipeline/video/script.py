...
def build_prompt(cand: Candidate, post: PostContent, voice: dict, cfg: dict,
    ...
    system = (
        ...
        "'chart': {kind:'stat'|'line'|'bar'|'hbar', items:[...], unit?, title?} — "
        "'title' là NHÃN NGẮN (tối đa 45 ký tự) nói khối số liệu này đo cái gì, ví dụ "
        "'Giá đầu ra mỗi 1 triệu token', 'Hạn ngạch tin mỗi 5 giờ'. TUYỆT ĐỐI không "
        "chép lại câu thoại: lời thoại đã chạy ở phụ đề dưới đáy, in lại là chữ chồng chữ. "
